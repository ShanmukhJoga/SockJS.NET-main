    ...
    public class SockJS : IClient
    {
        ...
        public async Task Connect(CancellationToken token)
        {
            ...
            try
            {
                ...
                var subscribetopic = JsonConvert.SerializeObject(topicMessage4);
                //this.Message?.Invoke(this, subscribetopic);
                TransportOnMessage(this, subscribetopic);
            }
            catch (Exception e)
            {
       ...
       // public Task SendWithTopic(string data) => this.SendWithTopic(data, CancellationToken.None);

        public async Task SendWithTopic(string data)
        {
            this.VerifyEstablished();
            await this._transport!.SendWithTopic(data);
        }
        ...
        public async Task RecieveWithTopic(string data)
        {

            this.VerifyEstablished();
           await this._transport!.RecieveWithTopic(data);
        }
    }
}